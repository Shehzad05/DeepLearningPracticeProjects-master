...
#load model
model = keras.models.load_model('horse_or_human_predictor.h5')
 
print('@@ Model loaded')
 
 
def pred_human_horse(horse_or_human):
  test_image = tf.keras.preprocessing.image.load_img(horse_or_human, target_size=(150,150)) # load image 
...
def predict():
     if request.method == 'POST':
        ...
        return {"Error":'please request the post'} 
